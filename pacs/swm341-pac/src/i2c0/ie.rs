...
pub type TXE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IE_SPEC, bool, O>;
#[doc = "Field `RXNE` reader - RXNE field"]
pub type RXNE_R = crate::BitReader<bool>;
#[doc = "Field `RXNE` writer - RXNE field"]
pub type RXNE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IE_SPEC, bool, O>;

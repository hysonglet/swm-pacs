...
pub type WKUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
#[doc = "Field `ERRPASS` reader - ERRPASS field"]
pub type ERRPASS_R = crate::BitReader<bool>;
#[doc = "Field `ERRPASS` writer - ERRPASS field"]
pub type ERRPASS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;

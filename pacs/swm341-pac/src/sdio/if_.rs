...
pub type CMDTIMEOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
pub type CMDCRCERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
pub type CMDENDERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
pub type CMDIDXERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
pub type DATTIMEOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
pub type DATCRCERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
pub type DATENDERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 15 - ERROR field"]
    #[inline(always)]
    pub fn error(&self) -> ERROR_R {
        ERROR_R::new(((self.bits >> 15) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 15 - ERROR field"]
    #[inline(always)]
    pub fn error(&mut self) -> ERROR_W<15> {
        ERROR_W::new(self)
    }
    #[doc = "Bit 16 - CMDTIMEOUT field"]
    #[inline(always)]

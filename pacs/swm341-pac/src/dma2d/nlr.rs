...
#[doc = "Field `NLINE` reader - NLINE field"]
pub type NLINE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `NLINE` writer - NLINE field"]
pub type NLINE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, NLR_SPEC, u16, u16, 16, O>;
#[doc = "Field `NPIXEL` reader - NPIXEL field"]
pub type NPIXEL_R = crate::FieldReader<u16, u16>;
#[doc = "Field `NPIXEL` writer - NPIXEL field"]
pub type NPIXEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, NLR_SPEC, u16, u16, 14, O>;
impl R {
    #[doc = "Bits 0:15 - NLINE field"]
    #[inline(always)]
    pub fn nline(&self) -> NLINE_R {
        NLINE_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:29 - NPIXEL field"]
    #[inline(always)]
    pub fn npixel(&self) -> NPIXEL_R {
        NPIXEL_R::new(((self.bits >> 16) & 0x3fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - NLINE field"]
    #[inline(always)]
    pub fn nline(&mut self) -> NLINE_W<0> {
        NLINE_W::new(self)
    }
    #[doc = "Bits 16:29 - NPIXEL field"]
    #[inline(always)]
    pub fn npixel(&mut self) -> NPIXEL_W<16> {
        NPIXEL_W::new(self)
    }

...
#[doc = "Field `GO` reader - GO field"]
pub type GO_R = crate::BitReader<bool>;
#[doc = "Field `GO` writer - GO field"]
pub type GO_W<'a, const O: u8> = crate::BitWriter<'a, u32, START_SPEC, bool, O>;
impl R {
    #[doc = "Bit 1 - GO field"]
    #[inline(always)]
    pub fn go(&self) -> GO_R {
        GO_R::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - GO field"]
    #[inline(always)]
    pub fn go(&mut self) -> GO_W<1> {
        GO_W::new(self)
    }
